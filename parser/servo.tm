...
eventBased = true
lang = "go"
package = "github.com/egoodhall/servo/parser/parsegen"
...
OptionScalar: OptionName | OptionString | OptionBool | OptionInt | OptionFloat;
OptionSliceElement: OptionScalar;
OptionSlice -> OptionSlice: '[' WS* OptionSliceElement (',' WS* OptionSliceElement)* WS* ']';
OptionMapKey: OptionScalar;
OptionMapValue: OptionScalar;
OptionMapEntry: OptionMapKey ':' OptionMapValue;
OptionMap -> OptionMap: '{' WS* OptionMapEntry (',' WS* OptionMapEntry)* WS* '}';
OptionValue: OptionName | OptionString | OptionBool | OptionInt | OptionFloat | OptionSlice | OptionMap;
